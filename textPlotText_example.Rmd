...
source(
  "r-text_misc/textPlotText_test.R", # plotting functions
...
toPredEmbed <- textEmbed(data[1:10,"harmonytexts"],
                         model=nameLLM,
...
toPred <- addSentenceEmbeddings(toPredEmbed, tokenizer, nameLLM, include_CLS_SEP="both")
