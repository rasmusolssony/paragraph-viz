...
model_folder_path <- paste0("models/", nameLLM, "-", text_set, "-", train_size, "-trimodel") # nolint: line_length_linter.
...
if(!file.exists(paste0(model_folder_path, "/models.rds")) || force_train){
  ...
  theModels <- trainLanguageModel(embed, # embedding
                        ...
                        "all", # options: "token", "sentence", "paragraph", "all", # "all" include all the previous models
                        modelName = nameLLM
  )
